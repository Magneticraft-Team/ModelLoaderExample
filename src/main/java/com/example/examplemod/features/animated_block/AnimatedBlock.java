...
public class AnimatedBlock extends Block implements IModelRegisterer, ITileEntityProvider {
    ...
    public AnimatedBlock() {
        ...
        setRegistryName(ExampleMod.MOD_ID, "animated_block");
    ...
    public void registerModels() {
        ...
        ResourceLocation modelLocation = new ResourceLocation(ExampleMod.MOD_ID, "models/block/animated_block.gltf");
